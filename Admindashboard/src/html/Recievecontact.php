    ...
    <tbody>
      ...
      if(mysqli_num_rows($runn)){
        ...
        <tr>
            ...
            <td><?php echo $rows ['C_message']?></td>
            <!-- <td>
             <a href="quote_delete.php?id=<?php echo $rows['C_id']?>"> <button class="btn btn-primary m-1">Delete</button></a>
              <a href="quote_update.php?id=<?php echo $rows['C_id']?>"><button class="btn btn-danger m-1">Update</button> </a>
            </td> -->
        </tr>
        <?php
