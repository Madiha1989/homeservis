...
<h2 style="padding:20px; text-align:center;" class="text-danger">User_Quote Recieving Table</h2>
<!-- table start -->
<table class="table text-center">
    ...
    <tbody>
      ...
      if(mysqli_num_rows($runn)){
        ...
        <tr>
            <td><?php echo ++$sno; ?></td>
            <td><?php echo $rows ['Q_name']?></td>
            <td><?php echo $rows ['Q_email']?></td>
            <td><?php echo $rows ['Q_contact']?></td>
            <td><?php echo $rows ['Q_service']?></td>
            <td><?php echo $rows ['Q_address']?></td>
            <td>
             <a href="deletequote.php?id=<?php echo $rows['Q_id']?>"> <button class="btn btn-primary m-1">Delete</button></a>
            </td>
        </tr>
        <?php
